...
"resh()>Refresh</button>\n<button class=secondary onclick=\"j('/api/identify',{method:'POST',headers:{'Content-Type':'application/json'},body:'{\\\"cmd\\\":\\\"hub\\\"}'}).then(()=>toast('Hub LED identify'))\">Hub LED</button>\n</div>\n<div class=grid>\n<div class=card><h2 style=\"margin:0 0 .75rem;font-size:1rem\">Paired devices</h2><div id=devices>…</div></div>\n<div class=card><h2 style=\"margin:0 0 .75rem;font-s"
